...
print(f"Avg. Accel. Protobuf Ser. t_sub_i   = {avg(acc_proto_t_sub_i)}")
print(f"Avg. Accel. Protobuf Ser. t_setup_i = {avg(acc_proto_t_setup_i)}")
print(f"Avg. Accel. SHA3 Hashing  t_sub_i   = {avg(acc_sha3_t_sub_i)}")
print(f"Avg. Accel. SHA3 Hashing  t_setup_i = {avg(acc_sha3_t_setup_i)}")
